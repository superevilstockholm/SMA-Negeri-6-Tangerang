...
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Edit Group</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Update this group.</p>
                    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.gallery.groups.update', $group->id) }}" autocomplete="off"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-floating mb-3">
                            <input name="title" class="form-control @error('title') is-invalid @enderror" id="floatingInputTitle"
                                placeholder="Title" autocomplete="off" value="{{ old('title', $group->title) }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="floatingInputDescription"
                                placeholder="Description" autocomplete="off" data-lenis-prevent>{{ old('description', $group->description) }}</textarea>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary d-flex align-items-center gap-2 justify-content-center px-4 rounded-pill">
                                <i class="ti ti-device-floppy me-1"></i> Update Group
                            </button>
                        </div>
                    </form>
                </div>
