                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select name="group_id" id="filterGroupName"
                                        ...
                                        <option value="" {{ (old('group_id', request('group_id')) === null || old('group_id', request('group_id'))) === '' ? 'selected' : '' }}>All Groups</option>
                                        <option value="0" {{ old('group_id', request('group_id')) == '0' ? 'selected' : '' }}>Without Group</option>
