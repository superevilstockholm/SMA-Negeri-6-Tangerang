...
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Edit Teacher</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Update this teacher.</p>
                    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.master-data.teachers.update', $teacher->id) }}" autocomplete="off"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="floatingInputName"
                                placeholder="Name" autocomplete="off" value="{{ old('name', $teacher->name) }}" required autofocus>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" id="floatingInputNIP"
                                placeholder="NIP" autocomplete="off" value="{{ old('nip', $teacher->nip) }}" inputmode="numeric" maxlength="18" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="dob" class="form-control @error('dob') is-invalid @enderror" id="floatingInputDOB"
                                placeholder="Birth Date" autocomplete="off" value="{{ old('dob', $teacher->dob->format('Y-m-d')) }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <select name="gender" id="floatingInputGender" class="form-select @error('gender') is-invalid @enderror" required>
                                <option value="" {{ old('gender', $teacher->gender) ? '' : 'selected' }} disabled>
                                    Select Gender
                                </option>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary d-flex align-items-center gap-2 justify-content-center px-4 rounded-pill">
                                <i class="ti ti-device-floppy me-1"></i> Update Teacher
                            </button>
                        </div>
                    </form>
                </div>
