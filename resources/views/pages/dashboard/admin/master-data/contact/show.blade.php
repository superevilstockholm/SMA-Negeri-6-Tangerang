...
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Vision Details</h3>
                        <p class="p-0 m-0 fw-medium text-muted">View detailed information about this vision.</p>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title fw-semibold mb-3">Vision Details</h4>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 fw-medium">{{ $vision->order ?? '-' }}</div>
                    </div>
                    <h4 class="card-title fw-semibold mt-4 mb-3">System Information</h4>
                    <div class="row mb-3">
                        <div class="col-md-4 text-muted">Vision ID</div>
            ...
            <div class="card my-0">
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        This page displays detailed information about the selected vision. To make changes, click the "Edit Vision" button.
                    </p>
                </div>
            </div>
        </div>
