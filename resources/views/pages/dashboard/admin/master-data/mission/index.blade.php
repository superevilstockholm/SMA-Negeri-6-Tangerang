            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Mission Records</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Manage mission records.</p>
                    </div>
                    <div class="d-flex align-items-center">
                        <a href="{{ route('dashboard.admin.master-data.missions.create') }}"
                            class="btn btn-sm btn-primary px-4 rounded-pill m-0">
                            <i class="ti ti-plus me-1"></i> Create Mission
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div
                            ...
                            <div class="text-muted small">
                                @if ($missions instanceof LengthAwarePaginator)
                                    Showing {{ $missions->firstItem() }} to {{ $missions->lastItem() }} of
                                    {{ $missions->total() }} entries
                                @else
                                    Showing {{ $missions->count() }} entries
                                @endif
                            </div>
                        </div>
                            ...
                            <tbody>
                                @forelse ($missions as $index => $mission)
                                    <tr>
                                        ...
                                        <td>{{ $mission->content ? Str::limit($mission->content, 60) : '-' }}</td>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center">
                                            <div class="alert alert-warning my-2" role="alert">
                                                No mission records found for the selected filters.
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
