...
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Create Vision</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Create a new user account.</p>
                    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.master-data.visions.store') }}" autocomplete="off" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-floating mb-3">
                            <textarea type="content" name="content" class="form-control @error('content') is-invalid @enderror"
                                id="floatingInputContent" placeholder="Vision Content" value="{{ old('content') }}"
