...
@section('title', 'Create School History')
@section('content')
    <div class="row mb-4">
        <div class="col">
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Create School History</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Create a new school history.</p>
                    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.master-data.school-histories.store') }}" autocomplete="off"
                        method="POST">
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" name="start_year" class="form-control @error('start_year') is-invalid @enderror" id="floatingInputStartYear"
                                placeholder="Start Year" autocomplete="off" value="{{ old('start_year') }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" name="end_year" class="form-control @error('end_year') is-invalid @enderror" id="floatingInputEndYear"
                                placeholder="End Year" autocomplete="off" value="{{ old('end_year') }}">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary d-flex align-items-center gap-2 justify-content-center px-4 rounded-pill">
                                <i class="ti ti-device-floppy me-1"></i> Save School History
                            </button>
                        </div>
                    </form>
                </div>
