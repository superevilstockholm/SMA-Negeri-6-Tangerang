        ...
        <div class="container-fluid h-100">
            <div class="row h-100 align-items-center justify-content-center">
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card shadow-none border-0" style="max-width: 350px;">
                        <div class="card-body">
                            <h1 class="h3 text-center fw-semibold mb-0">WELCOME BACK</h1>
                            <p class="text-muted text-center fw-medium ff-open-sans">Login to your account to access your dashboard!</p>
                            <form class="p-0 m-0" action="{{ route('login_attempt') }}" method="POST">
                                @csrf
                                <div class="form-group mb-3">
                                    <label class="mb-2 fw-medium" for="email">Email</label>
